...
class makeWordCloud(object):
    def __init__(self):
        ...
        self.background = imread('background.jpg')
    ...
    def randomGetText(self, asin):  # 随机asin中的星级 颜色 和 尺寸
        ...
        color_check = random.randint(0, 1)
        size_check = random.randint(0, 1)
        star_check = random.randint(0, 1)
        searchState = {}
        if color_check:
